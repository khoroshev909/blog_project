...
describe('initArticleListPage.test', function () {
    test('success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thunk = new TestAsyncThunk(initArticleListPage, {
                        articleList: {
                            _init: false,
                            page: 1,
                            limit: 4,
    ...
    test('allredy inited', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
