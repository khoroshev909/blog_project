...
export var initArticleListPage = createAsyncThunk('articles/initArticleListPage', function (_, thunkAPI) { return __awaiter(void 0, void 0, void 0, function () {
    var dispatch, getState, isInit;
    return __generator(this, function (_a) {
        dispatch = thunkAPI.dispatch, getState = thunkAPI.getState;
        try {
            isInit = getArticleListInit(getState());
            if (!isInit) {
