...
describe('fetchNextArticlePage.test', function () {
    test('success', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    thunk = new TestAsyncThunk(fetchNextArticlePage, {
                        articleList: {
                            loading: false,
                            error: undefined,
                            hasMore: true,
    ...
    test('not called', function () { return __awaiter(void 0, void 0, void 0, function () {
        var thunk;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
