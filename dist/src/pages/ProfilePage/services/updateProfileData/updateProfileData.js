...
export var updateProfileData = createAsyncThunk('profile/updateProfileData', function (profileId, thunkAPI) { return __awaiter(void 0, void 0, void 0, function () {
    var api, formData, errors, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                api = thunkAPI.extra.api;
                formData = getProfileForm(thunkAPI.getState());
                errors = validateProfileErrors(formData);
                if (errors.length) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, api.put("/profile/".concat(profileId), formData)];
            case 2:
                response = _a.sent();
            ...
            case 3:
                e_1 = _a.sent();
                return [2 /*return*/, thunkAPI.rejectWithValue('Profile Error')];
