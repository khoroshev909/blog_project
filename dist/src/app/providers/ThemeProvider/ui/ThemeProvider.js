...
var defaultTheme = localStorage.getItem(LOCAL_STORAGE_THEME_KEY) || THEMES.LIGHT;
export var ThemeProvider = function (props) {
    ...
    var defaultProps = useMemo(function () { return ({ theme: theme, setTheme: setTheme }); }, [theme]);
